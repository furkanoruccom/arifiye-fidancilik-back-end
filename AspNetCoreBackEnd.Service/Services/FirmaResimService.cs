...
{
    public class FirmaResimService : Service<FirmaResimleri>, IFirmaResimService
    {
        private readonly IFirmaResimRepository _main_repository;
        private readonly IMapper _mapper;


        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMemberService _memberService;
        public FirmaResimService(IGenericRepository<FirmaResimleri> repository, IUnitOfWork unitOfWork, IMapper mapper, IFirmaResimRepository main_repository, IHttpContextAccessor httpContextAccessor, IMemberService memberService)
        ...
        public async Task<FirmaResimReturnModel> TableDataAsync(DataTableModel table, int firmaId)
        {
            ...
            return (new FirmaResimReturnModel()
            {
