...
{
    public class HaberService : Service<Haberler>, IHaberService
    {
        private readonly IHaberRepository _main_repository;
        ...
        public HaberService(IGenericRepository<Haberler> repository, IUnitOfWork unitOfWork, IMapper mapper, IHaberRepository main_repository, IHttpContextAccessor httpContextAccessor, IMemberService memberService)
        ...
        public async Task<HaberReturnModel> TableDataAsync(DataTableModel table)
        {
