...
{
    public class FormService : Service<Forms>, IFormService
    {
        private readonly ITFormRepository _main_repository;
        private readonly IMapper _mapper;

        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMemberService _memberService;

        public FormService(IGenericRepository<Forms> repository, IUnitOfWork unitOfWork, IMapper mapper, ITFormRepository main_repository, IHttpContextAccessor httpContextAccessor, IMemberService memberService)
        ...
        public async Task<FormReturnModel> TableDataAsync(DataTableModel table)
        {
