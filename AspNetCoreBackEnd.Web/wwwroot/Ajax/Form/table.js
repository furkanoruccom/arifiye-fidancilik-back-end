        ...
        "columns": [
            ...
            },
            {
                "data": "cv", "render": function (data) {
                    return `<a href="/Uploads/${data}" target="_blank" class="btn btn-primary btn-sm me-1" >Cv</a>`;
                }
            },
            {
                "data": "createdDate",
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    return `<button type="button" class="btn btn-danger me-1 deleteButton" data-id="${row.id}" data-bs-toggle="tooltip" title="Delete Case"><i class="fa-solid fa-trash"></i></button>`;
                }
            }
        ],
        "language": {
