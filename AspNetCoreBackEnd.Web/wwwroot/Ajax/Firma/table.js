        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var id = row.id,
                        buttons = `<a class='btn btn-warning me-1' href="/Firma/Update/${id}" data-bs-toggle="tooltip" title="Update Case"><i class="fa-solid fa-pen"></i></a>
                                <a class='btn btn-primary me-1' href="/FirmaResim/Index/${id}" data-bs-toggle="tooltip" title="Medias"><i class="fa-solid fa-image"></i></a>
