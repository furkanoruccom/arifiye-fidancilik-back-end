        ...
        "columns": [
            ...
            { "data": "orderNo" },
            {
                ...
                "data": null, "render": function (row) {
                    return `
                        <a href="/Uploads/${row.mediaName}" target="_blank">
                            <img src="/Uploads/${row.mediaName}" class="img-fluid" alt="Responsive image" style="max-width: 100px; max-height: 100px;">
                        </a>
                   `;
                }
            ...
            },
            {
                ...
                "data": null, "render": function (row) {
                    ...
                    var buttons = `
                    <a class='btn btn-warning me-1' href="/FirmaResim/Update/${id}" data-bs-toggle="tooltip" title="Edit Slide"><i class="fa-solid fa-pen"></i></a>
