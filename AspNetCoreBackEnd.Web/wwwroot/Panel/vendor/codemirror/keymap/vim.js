    ...
    function maybeInitVimState(cm) {
      if (!cm.state.vim) {
        ...
        cm.state.vim = {
          ...
          // cursor should Geri Dön to its horizontal position on the longer
    ...
    var operators = {
      ...
      indent: function(cm, args, ranges) {
        ...
        if (args.linewise) {
          ...
          // line. We don't want this in indent, so we Geri Dön a line.
          endLine--;
        }
    ...
    * in the right place.
    ...
    function findBeginningAndEnd(cm, head, symb, inclusive) {
      ...
      if (chars[cur.ch] == symb && !end) {
        ...
        // Geri Dönwards to find the start
    ...
    function findNextFromAndToInclusive(cm, prev, query, repeat, vim) {
      ...
      return cm.operation(function() {
        ...
        // Geri Dön one result to ensure that if the cursor is currently a match, we keep it.
        var found = cursor.find(!prev);

        // If we haven't moved, Geri Dön one more (similar to if i==0 logic in findNext).
