...
[javascript mode](https://codemirror.net/mode/javascript//): Add support for TypeScript template string types, improve integration with JSX mode.
...
[clojure mode](https://codemirror.net/mode/clojure//): Fix regexp that matched in exponential time for some inputs.
...
[pascal mode](https://codemirror.net/mode/pascal//): Recognize curly bracket comments.
...
* Handle `async`/`await` and ocal and binary numbers in [JavaScript mode](https://codemirror.net/mode/javascript//)
